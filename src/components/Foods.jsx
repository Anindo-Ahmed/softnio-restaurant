...
const Foods = () => {
    ...
    const productTemplate = (food) => {
        return (
            <div className="lg:mt-14 mt-8 text-center bg-white p-8 mr-3">
                <div className="mb-8">
                    <img src={food.image} alt={food.name} className="w-fit" />
                </div>
    ...
    return (
        <div className="md:px-[15%] px-[30px] py-8 lg:py-[120px] bg-[#FBF7F2]">
            <div>
                <div>
                    <span className="roboto test-base lg:text-xl font-bold text-[#BD1F17] flex items-center gap-2"> <FaSquareFull className="text-xs"/>Crispy, Every Bite Taste</span>
